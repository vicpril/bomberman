...
import { useArticlesPageIsLoading, useArticlesPageView } from '../../model/selectors/articlesPageSelectors'
...
const ArticlesPage = (props: ArticlesPageProps) => {
    ...
    return (
        <DynamicModuleLoader reducers={reducers} removeAfterUnmount={false}>
            ...
            >
                <ArticlesFilters view={view} onViewChange={onViewChange} onChange={onFiltersChange} />
