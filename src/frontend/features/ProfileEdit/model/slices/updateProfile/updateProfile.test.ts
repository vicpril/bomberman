...
describe('updateProfile.test', () => {
    test('test update profile', () => {
        ...
        expect(
            profileUpdateReducer(
                state as ProfileUpdateSchema,
                profileUpdateActions.updateProfileForm({ firstname: '123456' }),
            ),
    ...
    test('test update profile service pending', () => {
        ...
        expect(profileUpdateReducer(state as ProfileUpdateSchema, <Action>updateProfileData.pending)).toEqual(
    ...
    test('test update profile service fullfiled', () => {
        ...
        expect(
            profileUpdateReducer(
                state as ProfileUpdateSchema,
                updateProfileData.fulfilled(data, '', { data, id: '1' }),
            ),
        ).toEqual({
            isLoading: false,
