...
export class Player extends MovingEntity implements IEntity {
    ...
    protected hasBombs = PLAYER_HAS_BOMBS

    bombBlownSize = PLAYER_BOMB_BLOWS_SIZE

    protected frames: number = ANIMATION_FRAMES_PLAYER

    protected currentFrame: number = 0

    protected animationInterval: number = ANIMATION_INTERVAL_PLAYER

    protected interval: number = ANIMATION_INTERVAL_PLAYER

    constructor(protected canvasCtx: CanvasRenderingContext2D) {
        super({
