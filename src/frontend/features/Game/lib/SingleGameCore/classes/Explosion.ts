...
export type ExplosionFrameType = Extract<
    FrameEntities,
    FrameEntities.EXPLOSION_CENTER | FrameEntities.EXPLOSION_MIDDLE | FrameEntities.EXPLOSION_END
>

export type ExplosionFrameDirection = Extract<
    FrameActions,
    FrameActions.UP | FrameActions.RIGHT | FrameActions.DOWN | FrameActions.LEFT
>
...
export class Explosion implements IEntity {
    ...
    render() {
        ...
        getSpritesInstance().draw(
            this.canvasCtx,
            { x, y },
            this.frameType,
            this.frameType !== FrameEntities.EXPLOSION_CENTER ? this.frameDirection : FrameActions.PERMANENT,
            this.currentFrame,
        )
    }
}
