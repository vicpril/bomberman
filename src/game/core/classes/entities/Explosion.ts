...
export type ExplosionFrameDirection = Extract<
    FrameActions,
    FrameActions.PERMANENT | FrameActions.UP | FrameActions.RIGHT | FrameActions.DOWN | FrameActions.LEFT
>
...
export class Explosion extends AbstractEntity {
    ...
    constructor({ pos, BF, frameDirection, isCenter, isEnd }: ExplosionOptions) {
        super({ pos, BF })
